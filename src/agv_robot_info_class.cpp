...
void AGVRobotInfo::compile_info() {
  ...
  std::map<std::string, std::string> hyd_params = std::move(hsm_.get_parameters());
  msgs_.data_field_06 = "hydraulic_oil_temperature: " + hyd_params["hydraulic_oil_temperature"];
  msgs_.data_field_07 = "hydraulic_oil_tank_fill_level: " + hyd_params["hydraulic_oil_tank_fill_level"];
  msgs_.data_field_08 = "hydraulic_oil_pressure: " + hyd_params["hydraulic_oil_pressure"];
}
